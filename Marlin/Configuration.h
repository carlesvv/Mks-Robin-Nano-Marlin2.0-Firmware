...
#define STRING_CONFIG_H_AUTHOR "(TheMacBoy, Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5 Plus TMB"
...
#define TEMP_CHAMBER_RESIDENCY_TIME 8  // (seconds) Time to wait for chamber to "settle" in M191
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  15.96,  15.96 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 159.958, 160.356, 1600, 693.673 }
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 5, 60 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29.8, -13.5, -1.690} // inductiu
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 12/*+X_MIN_POS*/
