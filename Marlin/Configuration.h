...
#define STRING_CONFIG_H_AUTHOR "(TheMacBoy, Sapphire Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire Pro TMB"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sapphire Pro
  #define DEFAULT_bedKp 72.51
  #define DEFAULT_bedKi 14.27
  #define DEFAULT_bedKd 245.58
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 100, 250 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 600, 600, 100, 250 } // ...or, set your own edit limits
#endif
