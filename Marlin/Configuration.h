...
#define STRING_CONFIG_H_AUTHOR "(TheMacBoy, CR-10)" // Who made the changes.
 ...
 *   SMUFF_EMU_MMU2  : Technik Gegg SMUFF (Prusa MMU2 emulation mode)
 *   SMUFF_EMU_MMU2S : Technik Gegg SMUFF (Prusa MMU2S emulation mode)
 *
...
#define TEMP_BED_RESIDENCY_TIME 16  // (seconds) Time to wait for bed to "settle" in M190
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  24.69,  24.69 }
...
//#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 10, 20, 0.6, 20 } // ...or, set your own edit limits
  #endif
#endif
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.1152 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, 0, -1.640 }
...
#define TOUCH_SCREEN
  ...
  // #define TOUCH_CALIBRATION_X -17082
